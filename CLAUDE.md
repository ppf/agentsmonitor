...
- Determines running status via file mtime heuristic: sessions modified within last 15 minutes (900s) are "running", otherwise "completed"
...
1. **Running detection is heuristic-based:** Uses file mtime (15-minute / 900s threshold) since we can't reliably correlate OS processes to specific sessions
